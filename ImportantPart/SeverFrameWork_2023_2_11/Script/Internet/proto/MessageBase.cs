...
public class MessageBase
{
    ...
    {
        string s = JsonConvert.SerializeObject(messageBase, new JsonSerializerSettings() {StringEscapeHandling = StringEscapeHandling.EscapeNonAscii,NullValueHandling = NullValueHandling.Ignore});
    ...
    public static MessageBase Decode(string protoName,byte[] bytes,int offset,int count)
    {
        ...
        MessageBase messageBase = (MessageBase)JsonConvert.DeserializeObject(s, Type.GetType(protoName), new JsonSerializerSettings() {StringEscapeHandling = StringEscapeHandling.EscapeNonAscii,NullValueHandling = NullValueHandling.Ignore});
        return messageBase;
